...
/**
 * BuildingSearch represents the model behind the search form of `backend\models\Building`.
 */
class BuildingSearch extends Building
{
    ...
    {
        return [
            [['id', 'floor_qty', 'room_qty', 'status', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
